#!/usr/bin/env python3
"""
Script dịch song song nhiều records cùng lúc
"""
...
def translate_item(item):
    """Dịch một item - dùng cho parallel processing"""
...
def main():
    print("=== Bắt đầu chuyển đổi dữ liệu Medical Dialogue (Song song) ===\n")
    print(f"Số worker: {MAX_WORKERS}\n")
    ...
    print(f"=== Bắt đầu dịch song song {len(all_dialogues)} records ===\n")
